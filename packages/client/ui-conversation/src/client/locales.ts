...
export const zh = {
  ...
  'image.dropTitle': '图片或文件拖动到此处即可添加',
  ...
  'document.unsupportedType': '仅支持 TXT、Markdown、CSV、JSON、PDF、DOCX、XLSX 及常见代码文件',
  ...
  'document.extractionFailed': '无法从该文档提取文本，请换用可复制文本的文件',
  ...
  'command.done': '已完成',
  'command.title': '命令',
  'command.imagesUnsupported': '/{command} 不接受附件，请先移除',
  'command.documentsUnsupported': '/{command} 仅接受图片，请将文档放在普通消息中发送',
...
export const en = {
  ...
  'input.attach': 'Add attachments',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages',
  'input.accessMode': 'Access mode, current: {name}',
  'image.dropTitle': 'Drag images or files here to add them',
  ...
  'document.unsupportedType': 'Supports TXT, Markdown, CSV, JSON, PDF, DOCX, XLSX, and common code files',
  'document.pending': 'Pending document',
  ...
  'document.extractionFailed': 'No text could be extracted from this document; try a file with selectable text',
  ...
  'command.imagesUnsupported': '/{command} does not accept attachments; remove them first',
  'command.documentsUnsupported': '/{command} accepts images only; move documents to a plain message',

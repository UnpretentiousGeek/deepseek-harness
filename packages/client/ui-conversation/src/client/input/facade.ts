...
export class SessionInputShell implements SessionInput {
  ...
  /**
   * Keep only attachment ids that still resolve in the browser attachment registry.
  ...
  submit(mode: InputSubmitMode = 'queue'): void {
    ...
    // submits while attachments are attached — one notice, everything retained.
   ...
   * failure (serialize, transport, or handler error) keeps draft and
   * attachments for correction.
   */

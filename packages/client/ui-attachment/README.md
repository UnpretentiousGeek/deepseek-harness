...
- **Documents render as name chips** — draft documents have no raster preview and no history renderer; DeepSeek Chat-style file cards and upload-progress states remain future work.
